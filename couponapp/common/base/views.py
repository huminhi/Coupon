...
from lunex.common.v2.base.base_views import TemplateResponseMixin
from lunex.common.v2.utils.converters import EncodingUtils
from lunex.common.v2.base.mixins import JsonResponseMixin, CsvResponseMixin,\
    XmlResponseMixin, HtmlResponseMixin
from lunex.common.v2.base.views import AuthenticatedView
from lunex.common.v2.base.exceptions import UnsupportResponseFormat
from lunex.aaportal.common.utils import render_pdf
from lunex.aaportal.v2.base_gui.utils import MenuUtils, JqGridUtils,\
    NotificationUtils
from traceback import format_exception
import sys
from lunex.aaportal.v2.base_gui.exceptions import AjaxHandlerNotFound

logger = log.setup_logger('v2.base_gui.views')
...
class HtmlView(TemplateResponseMixin, AuthenticatedView):
    '''
    A view renders normal HTML page.
    '''
